...
Coloque o arquivo TXT na mesma pasta do .exe

Execute o programa

Informe o valor correto quando solicitado

Veja a validação final
...
A IA generativa foi utilizada como copiloto técnico, auxiliando principalmente em:

estruturação da lógica inicial
